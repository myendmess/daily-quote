...
Every quote ever published by the [daily pipeline](README.md) — one per day, newest first, each mirrored as a [YouTube Short](https://www.youtube.com/playlist?list=PLNiOPtRmph_w).

<!-- Machine-written file: the daily workflow inserts each new entry above the
